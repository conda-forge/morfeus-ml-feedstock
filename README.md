...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/morfeus-ml-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12585&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/morfeus-ml-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `morfeus-ml` can be installed with:

```
conda install morfeus-ml
```

It is possible to list all of the versions of `morfeus-ml` available on your platform with:
